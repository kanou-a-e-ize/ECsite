...
return [
    ...
    */
    ...
    'digits'               => ':attributeには:digits桁の半角数字を入力してください。',
    'digits_between'       => ':attributeには:min〜:max桁の半角数字を入力してください。',
    'dimensions'           => ':attributeには横::max_width px、縦::max_height px以内の画像を登録してください。',
    ...
    'integer'              => ':attributeには半角数字を入力してください。',
